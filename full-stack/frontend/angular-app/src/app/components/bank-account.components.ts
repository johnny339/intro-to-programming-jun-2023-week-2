...
export class BankAccountComponent {
    ...
    balance: Signal<number>;    //signal is a function imported from angular core
    //Tells angular that this variable will change this thing only                                
    // read new version of that value
